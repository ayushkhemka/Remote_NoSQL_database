 ...
 * --------------------
 * ver 1.2 : 23 Nov 2015
 * - Added ToString() function to convert List<string> to string, based on DBExtensions.cs
 * ver 1.1 : 24 Oct 2015
...
namespace Project4
{
  ...
  {
		public static string ToString(List<string> elem)
		{
			StringBuilder accum = new StringBuilder();
			bool first = true;
			foreach (string key in elem)
			{
				if (first)
				{
